...
| `postgresql.auth.password` | Set the postgres password | `ChangeMe,Please` |
| `postgresql.auth.database` | Set the postgres database name | `concourse` |
| `postgresql.extra_environment` | Add extra environement variables | `{}` |
| `postgresql.sensitive_environment` | Add extra sensitive env vars (will be injected with a secret) | `{}` |
...
| `postgresql.auth.user`     | PostgreSQL User to create | `concourse` |
